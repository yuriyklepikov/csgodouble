...
<head>
	...
	<title>Deposit - CSGODouble</title>
	...
	<script type="text/javascript" src="js/offers.js?v=1"></script>
</head>
...
<div class="text-center">
	...
	<div style="display:inline-block">
		...
		<div class="alert alert-info">
			<b><i class="fa fa-exclamation-circle"></i> After accepting the trade offer you MUST click the green "Get Coins" button to recieve your coins.</b>
		</div>
